...
public class PageObjectFormPage {
   ...
   // @FindBy(how = How.XPATH,using = ".//div[contains(text(), 'Черкизовская')]")
   // private SelenideElement metroStationSelector;
    ...
    /* public void pickMetroStationSelector(String metroStation){
        metroStationSelector.selectOptionByValue(metroStation);
    }
    */
    //5.телефон
    ...
    /*селектор для выбора даты в календаре
    @FindBy(how = How.XPATH,using = ".//div[@class='react-datepicker__week']/div[text()='10']")
    private SelenideElement calendarFieldValue;
    public void clickCalendarFieldValue() {
        calendarFieldValue.click();
    }
    */
    ...
    // Dropdown-menu
   // @FindBy(how = How.XPATH,using = ".//div[contains(text(), 'двое суток')]")
   // private SelenideElement leaseTimeFieldDropDownMenu;
...
//  public void pickLeaseTimeFieldDropDownMenu(String leaseTime){
//        leaseTimeFieldDropDownMenu.selectOptionByValue(leaseTime);
//    }
    //8.цвет два чек-бокса
    //для черного цвета
    //@FindBy(how = How.XPATH,using = "//div[@class='Order_Checkboxes__3lWSI']/input[@id='black']")
    ...
    public void orderSuccessMessageIsVisible() {
        ...
        //orderSuccessMessage.shouldHave(exactText("Заказ оформлен"));
